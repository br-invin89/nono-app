      ...
      <View style={{ position: 'relative', zIndex: 10 }}>        
        <View style={[{
          ...
          <View style={{
            ...
            <CountryInput selectedCountry={this.state.selectedCountry} 
        ...
        <View style={{
          ...
          {openedCountryPicker &&
            <CountryPicker styles={countryPikcerStyles} 
  ...
  render() {
    ...
    return ( 
      <TouchableOpacity style={{ 
        paddingVertical: 18*em, paddingHorizontal: 12*em,
        flexDirection: 'row'
      }} onPress={this.props.onOpenCountryPicker}>
        <Image source={{uri: selectedCountry['flag']}} style={{
          width: 22*em, height: 15*em,
        }}/>
        <Image source={require('~/common/assets/images/png/arrow2.png')} style={{
          tintColor: '#fff', marginTop: 4*em, marginLeft: 4*em
        }} />
      </TouchableOpacity>
    )
  }
    ...
    return (
      <ScrollView style={{
        ...
        {Object.keys(countries).map((countryCode) => (
          <TouchableOpacity style={{
            flexDirection: 'row', padding: 5*em
          }} onPressOut={() => this.props.onChangeCountry(countryCode)}>
            <Image source={{uri: countries[countryCode]['flag']}} style={{
              width: 22*em, height: 15*em, marginRight: 8*em
            }}/>
...
class NumberInput extends React.Component {
  render() {
    return (
      <View style={{
        paddingVertical: 16*em, paddingHorizontal: 12*em,
      }}>
        <TextInput style={[{
