...
export default class Button extends React.Component {
  render() {
    const { onPress, bgGradientStart } = this.props
    const { containerHeight, borderRadius } = this.props
  ...
  renderContent = () => {
    const { caption, loading, textSize, textColor, icon, iconAlign, iconColor } = this.props
    return (
      <>
        {loading?
